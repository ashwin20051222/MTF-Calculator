...
// Use the SVG favicon directly — this is the user's uploaded bar-chart logo design
export const Logo: React.FC<LogoProps> = ({ className = 'w-8 h-8', size = 36 }) => {
  return (
    ...
    >
      ...
      <rect width="100" height="100" rx="22" fill="#6b6d13" />
      {/* Baseline */}
      <line x1="18" y1="82" x2="82" y2="82" stroke="#848b29" strokeWidth="2.5" strokeLinecap="round" />
